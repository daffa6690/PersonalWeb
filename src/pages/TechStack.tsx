      ...
      <div className="relative overflow-hidden">
        ...
        >
          {techs.map((tech, idx) => (
            ...
            >
              <div className="w-20 h-20 sm:w-16 sm:h-16 bg-white dark:bg-gray-800 rounded-xl p-4 flex items-center justify-center shadow transition-transform hover:scale-105 hover:shadow-lg text-5xl">
                {tech.icon}
              </div>
              <span className="mt-3 text-lg text-gray-600 dark:text-gray-400">
                {tech.name}
              </span>
            </div>
          ))}
